                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="text-center mt-3">
                            ...
                            <h6 class="font-18"><i class="mdi mdi-arrow-up-bold-hexagon-outline text-success"></i> <span
                                    class="text-dark">1.78%</span> <small></small></h6>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="text-center mt-3">
                            ...
                            <h6 class="font-18"><i class="mdi mdi-arrow-up-bold-hexagon-outline text-success"></i> <span
                                    class="text-dark">25.87</span> <small>USD</small></h6>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="text-center mt-3">
                            ...
                            <h6 class="font-18"><i class="mdi mdi-arrow-up-bold-hexagon-outline text-success"></i> <span
                                    class="text-dark">87,4517</span> <small>USD</small></h6>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="text-center mt-3">
                            <h6 class="font-normal text-muted font-14">Conversion Rate</h6>
                            <h6 class="font-18"><i class="mdi mdi-arrow-up-bold-hexagon-outline text-success"></i> <span
                                    class="text-dark">3.94%</span> <small></small></h6>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="text-center mt-3">
                    ...
                    <div class="col-sm-4">
                        <div class="text-center mt-3">
                            ...
                            <h6 class="font-18"><i class="mdi mdi-arrow-up-bold-hexagon-outline text-success"></i> <span
                                    class="text-dark">124,858.67</span> <small>USD</small></h6>
                        </div>
                    </div>
                </div>
            ...
            <div class="card-box">
                ...
                <div class="inbox-widget slimscroll" style="max-height: 370px;">
                    <a href="#">
                        <div class="inbox-item">
                            <div class="inbox-item-img"><img
                                    src="<?= base_url('DarkAbstackAdmin/dist/assets/images/users/avatar-1.jpg') ?>"
                    ...
                    <a href="#">
                        <div class="inbox-item">
                            <div class="inbox-item-img"><img
                                    src="<?= base_url('DarkAbstackAdmin/dist/assets/images/users/avatar-2.jpg') ?>"
                                    class="rounded-circle bx-shadow-lg" alt=""></div>
                    ...
                    <a href="#">
                        <div class="inbox-item">
                            <div class="inbox-item-img"><img
                                    src="<?= base_url('DarkAbstackAdmin/dist/assets/images/users/avatar-3.jpg') ?>"
                                    class="rounded-circle bx-shadow-lg" alt=""></div>
                    ...
                    <a href="#">
                        <div class="inbox-item">
                            <div class="inbox-item-img"><img
                                    src="<?= base_url('DarkAbstackAdmin/dist/assets/images/users/avatar-4.jpg') ?>"
                                    class="rounded-circle bx-shadow-lg" alt=""></div>
                    ...
                    <a href="#">
                        <div class="inbox-item">
                            <div class="inbox-item-img"><img
                                    src="<?= base_url('DarkAbstackAdmin/dist/assets/images/users/avatar-5.jpg') ?>"
                                    class="rounded-circle bx-shadow-lg" alt=""></div>
                    ...
                    <a href="#">
                        <div class="inbox-item">
                            <div class="inbox-item-img"><img
                                    src="<?= base_url('DarkAbstackAdmin/dist/assets/images/users/avatar-6.jpg') ?>"
                                    class="rounded-circle bx-shadow-lg" alt=""></div>
                    ...
                    <a href="#">
                        <div class="inbox-item">
                            <div class="inbox-item-img"><img
                                    src="<?= base_url('DarkAbstackAdmin/dist/assets/images/users/avatar-8.jpg') ?>"
                                    class="rounded-circle bx-shadow-lg" alt=""></div>
                    ...
                    <a href="#">
                        <div class="inbox-item">
                            <div class="inbox-item-img"><img
                                    src="<?= base_url('DarkAbstackAdmin/dist/assets/images/users/avatar-9.jpg') ?>"
                                    class="rounded-circle bx-shadow-lg" alt=""></div>
                ...
                <div class="comment-list slimscroll" style="max-height: 370px;">
                    ...
                    <a href="#">
                        <div class="comment-box-item">
                            ...
                            <p class="commnet-item-date">1 month ago</p>
                            <h6 class="commnet-item-msg">Hello, what is your plan to upgrade Bootstrap 4 versions? Beta
                                or wait for stable?</h6>
                            <p class="commnet-item-user">Ubold User</p>
                        </div>
                    </a>
                    <a href="#">
                        <div class="comment-box-item">
                            ...
                            <p class="commnet-item-date">1 month ago</p>
                            <h6 class="commnet-item-msg">Hi coderthemes – do you have PSD for this admin UI? I could
                                really use it.</h6>
                            <p class="commnet-item-user">Ubold User</p>
                        </div>
                    </a>
